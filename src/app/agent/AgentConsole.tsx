...
export default function AgentConsole() {
  ...
  return (
    <div className="relative isolate px-6 pb-16">
      <section className="mx-auto mt-8 max-w-[108rem] overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-8 shadow-lg backdrop-blur md:p-10 dark:border-white/10 dark:bg-slate-900/80">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <div className="space-y-4">
            <Card>
              ...
              <div className="space-y-3 rounded-2xl border border-slate-200/60 bg-white/70 p-3 dark:border-slate-800/60 dark:bg-slate-900/60">
